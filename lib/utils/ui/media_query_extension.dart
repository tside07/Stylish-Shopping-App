...
extension MediaQueryExt on BuildContext {
  BuildContext get root =>
      findAncestorStateOfType<State<WidgetsApp>>()!.context;

  FlutterView get flutterView => View.of(this);

  MediaQueryData get rootViewMediaQueryData =>
  ...
  double get rootDevicePixelRatio => rootViewMediaQueryData
      .devicePixelRatio; // MediaQuery.devicePixelRatioOf(root);

  double get rootTextScaleFactor =>
      flutterView.platformDispatcher.textScaleFactor;
  ...
  double textScalerForDimensions(double dimensions) =>
      textScaler.scale(dimensions) / dimensions;
  ...
  Size proportionateToScreenSize(
    ...
    return Size(
      proportionateToScreenWidth(
        designWidth,
        designScreenWith: designScreenWith,
      ),
      proportionateToScreenHeight(
        designWidth,
